...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css">
   ...
   <c:if test="${ not empty alertMsg }">
	...
	<div id="logologin">
            <div id="logo-area">
            	<a href="${root}/home">
	                <img src="${root}/resources/img/Logo.png" alt="로고이미지">
            	</a>
            </div>
            <div>
            <button class="btn btn-primary btn-lg" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasWithBothOptions" aria-controls="offcanvasWithBothOptions">리뷰 작성하기<br>리뷰 확인하기</button>
		...
		<label>
			...
			<div id="search-area">
			<input type="text" placeholder="Seach items or categories you want!" name="text" class="input"></div>
            <div id="member-area">
