...
<link rel="stylesheet" href="${root}/resources/css/common/header.css">
   ...
   <c:if test="${ not empty alertMsg }">
	...
	<div id="logo-search-area">
            <div id="logoArea">
            	<a href="${root}/home">
	                <img id="logoImg" style="width: 120px; height: 120px; margin-left: 20px;" src="${root}/resources/img/Logo.png" alt="로고이미지">
            	</a>
            </div>
			<div id="search-area">
				<input type="text" placeholder="Seach items or categories you want!" name="text" class="input">
			</div>
			<div id="slogan">
			  ...
			  <div class="container-fluid">
			    <ul class="navbar-nav nav-underline">
			      <li class="nav-item mx-4">
			        <div class="nav-link" data-bs-toggle="offcanvas" data-bs-target="#offcanvasWithBothOptions" aria-controls="offcanvasWithBothOptions"><dt class="text-muted lead fw-bold">리뷰 확인하기</dt></div>
			      </li>
			      <li class="nav-item mx-4">
			        <a class="nav-link" href="#"><dt class="text-muted lead fw-bold">리뷰 작성하기</dt></a>
			      </li>
			      <li class="nav-item mx-4">
			        <a class="nav-link" href="#"><dt class="text-muted lead fw-bold">자유게시판</dt></a>
			      </li>
			    </ul>
	          <c:if test="${empty mvo}">
					...
					<div id="goCategory">
						<div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel">
							<div class="offcanvas-header">
								<h5 class="offcanvas-title" id="offcanvasWithBothOptionsLabel">Click on the category menu below to write review, or you want to see.</h5>
